...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // error displayed from mutation state
        }
    };
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
                ...
                <div>
                    ...
                    {isRegisterMode && (
                        <div className="mb-4">
                            ...
                            <input
                                type="password" value={confirmPassword} id="confirm-password"
                    ...
                    {(loginMutation.isError || registerMutation.isError) && (
                        <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 text-red-600 mt-0.5 shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                    <p className="text-xs text-gray-500 text-center">
                        Bootstrap accounts available after first startup
                    </p>
                </div>
            </div>
        </div>
